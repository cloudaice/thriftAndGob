...
type ProxyTrans interface {
	// Parameters:
	//  - Messages
	Log(messages []*LogEntry) (r ResultCode, err error)
}

type ProxyTransClient struct {
...
func NewProxyTransClientFactory(t thrift.TTransport, f thrift.TProtocolFactory) *ProxyTransClient {
	return &ProxyTransClient{Transport: t,
		ProtocolFactory: f,
...
func NewProxyTransClientProtocol(t thrift.TTransport, iprot thrift.TProtocol, oprot thrift.TProtocol) *ProxyTransClient {
	return &ProxyTransClient{Transport: t,
		ProtocolFactory: nil,
		InputProtocol:   iprot,
...
// Parameters:
//  - Messages
func (p *ProxyTransClient) Log(messages []*LogEntry) (r ResultCode, err error) {
...
func (p *ProxyTransClient) sendLog(messages []*LogEntry) (err error) {
...
func (p *ProxyTransClient) recvLog() (value ResultCode, err error) {
...
type ProxyTransProcessor struct {
	processorMap map[string]thrift.TProcessorFunction
	handler      ProxyTrans
}

func (p *ProxyTransProcessor) AddToProcessorMap(key string, processor thrift.TProcessorFunction) {
	p.processorMap[key] = processor
}

func (p *ProxyTransProcessor) GetProcessorFunction(key string) (processor thrift.TProcessorFunction, ok bool) {
	processor, ok = p.processorMap[key]
	return processor, ok
}

func (p *ProxyTransProcessor) ProcessorMap() map[string]thrift.TProcessorFunction {
	return p.processorMap
}

func NewProxyTransProcessor(handler ProxyTrans) *ProxyTransProcessor {

	self2 := &ProxyTransProcessor{handler: handler, processorMap: make(map[string]thrift.TProcessorFunction)}
	self2.processorMap["Log"] = &proxyTransProcessorLog{handler: handler}
	return self2
}

func (p *ProxyTransProcessor) Process(iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
...
type proxyTransProcessorLog struct {
	handler ProxyTrans
}

func (p *proxyTransProcessorLog) Process(seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	args := LogArgs{}
